...
However we calculate a mean of $e^2 \approx 7.39$ and standard deviation of $\sqrt{e^8 - e^4} \approx 54$, which are larger than we would like. However as the standard deviation is so large and the mass is in a location that we desire this prior is somewhat sensible. 
